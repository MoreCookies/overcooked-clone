      ...
      if (text_bubble.finished()) {
        ...
        if (scene === "intro") {
          ...
          text_bubble = new Dialogue([
            ...
            "Your first order is the start codon. \nThen follow the mRNA ticket exactly: ingredient by ingredient.",
            " When you finish dish #3 (stop codon), the monster will roar (release factor). \n If they roar, they’re happy! If they don’t, they get hangry and the world will burn.😨 \n",
            "Now get to it! \nYour monsters are waiting and Potato King IV is counting on you!"
          ]);
        } else {
          text_bubble = null;
        }
